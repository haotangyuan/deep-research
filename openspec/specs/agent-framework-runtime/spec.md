# agent-framework-runtime Specification

## Purpose
Defines the framework-selectable Deep Research agent runtime, including agentscope-java primary execution, langchain4j rollback support, neutral workflow state, tool-call equivalence, and verification expectations.
## Requirements
